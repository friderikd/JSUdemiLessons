...
form.addEventListener('submit', function(event) {//правильноеназначениеобработчика-наформуане кнопку(submit а не button)
    event.preventDefault(); //запрет стандартного поведения браузера (чтобы страница не перезагружалась)
...
formDown.addEventListener('submit', function(event) {
    event.preventDefault();
    formDown.appendChild(statusMessage);
